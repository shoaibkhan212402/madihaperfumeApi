...
const POLICIES = {
  ...
  'shipping-policy': {
    ...
    sections: [
      ...
      { heading: '2. Free Shipping', body: 'Enjoy free standard shipping on all prepaid (online payment) orders — no minimum order value required. A flat shipping fee of ₹60 applies to Cash on Delivery (COD) orders. All combo sets qualify for free shipping on prepaid orders regardless of order value.' },
